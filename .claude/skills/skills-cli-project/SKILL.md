...
- **Status:** shipped 2026-05-01 as Phase 5.5; agent mode v2 (Phase 5.8 on 2026-05-02) lifted the deferred `--json` and granular exit codes, completing this backlog entry. Companion skill lives at `.claude/skills/skills-cli-usage/SKILL.md`.
- **Raised:** 2026-04-30.
