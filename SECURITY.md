...
`skills-cli` (binary `skillctl`) is a local CLI. Its surface is small:
...
1. **Preferred:** use [GitHub's "Report a vulnerability"](https://github.com/umanio-agency/skills-cli/security/advisories/new) button on this repo.
